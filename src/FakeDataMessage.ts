...
export function getFolder(messageData: IMessage[], user: string): string[] {
  const folders = messageData
...
export function getMessageByFolder(folder: string, user: string): IMessage[] {
  return message.filter((item) => item.folder === folder && item.to === user);
}

export function getMessageById(id: string): IMessage {
